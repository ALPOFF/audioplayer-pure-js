let addPlayer = () => {
    ...
    audio.src = "https://www.bensound.com/bensound-music/bensound-summer.mp3";
    let trackTitleName = audio.src.split('/');

    audio.className = 'audio-player';
    audio.id = 'audio-player';

    trackTitle.className = "trackTitle";
    trackTitle.innerHTML = trackTitleName[trackTitleName.length - 1];
    ...
    imagePause.style = "color: #404040; display: none"
    ...
    downloadImage.style = "color: #404040";
    ...
    uploadImage.style = "color: #404040";
    ...
    const audioAct = () => {
        ...
        if (audioDuration.innerHTML == '00:00') {
            audioDuration.innerHTML = audioTime(audio.duration);
        }
    };
    ...
    const audioProgress = () => {
        ...
        audioCurrTime.innerHTML = audioTime(audio.currentTime);
    };
